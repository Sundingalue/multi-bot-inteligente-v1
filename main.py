...
            # 💥💥 CORRECCIÓN IMPORTANTE 💥💥
            # Los query args estaban llegando vacíos, ahora obtenemos los datos desde los headers de la conexión
            # Esto es más robusto y fiable con Render y Twilio.
...
            print("[WS] No se pudo obtener los headers de Twilio.")
